...
async def test_diagnosis_with_log_analysis():
    ...
    test_state = {
        ...
        "logs_data": """--- FRONTEND 服务日志 (ruoyi-frontend, 最�?0分钟, 16�? ---
...
--- BACKEND 服务日志 (ruoyi-app, 最�?0分钟, 50�? ---
    ...
    try:
        ...
        if content:
            ...
            checks = {
                ...
                "进行时间线分�?: "12:40" in content or "12:39" in content,
                "包含当前状态验�?: "【当前状态验�? in content or "当前状�? in content or "最�?分钟" in content,
