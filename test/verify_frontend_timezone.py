...
# 3. 检查时区配置
print("\n3️⃣  时区配置:")
stdin, stdout, stderr = ssh.exec_command('docker exec ruoyi-frontend cat /etc/timezone 2>/dev/null || echo "未设置"')
...
print(f"   {tz_env if tz_env else '未设置'}")
...
print("   3. 确认日志中的时间显示为北京时间 (例如: 19/May/2026:11:xx:xx +0800)")
print()
